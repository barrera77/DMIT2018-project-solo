...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=eBike_DMIT2018;Integrated Security=True;Encrypt=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Database__3214EC07B2436496");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Unordere__51BCD797DA1453A3");
        });
